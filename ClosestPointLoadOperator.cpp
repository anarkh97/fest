...
ClosestPointLoadOperator::ClosestPointLoadOperator(IoData &iod_, MPI_Comm &comm_)
...
void ClosestPointLoadOperator::LoadExistingSurfaces()
{
...
void
ClosestPointLoadOperator::ComputeForces(TriangulatedSurface& surface, std::vector<Vec3D> &force,
...
void 
ClosestPointLoadOperator::InterpolateInMetaSpace(TriangulatedSurface &surface, vector<vector<Vec3D>> &solutions, 
...
void
ClosestPointLoadOperator::InterpolateInTime(double t1, double* input1, double t2, double* input2,
