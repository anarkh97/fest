...
void print(FILE* fd, const char format[],...)
{
  ...
  //MPI_Barrier(fest_comm); (This slows down the code!)
  return;
}
...
void printHeader(int argc, char *argv[])
{
  ...
  if(!rank) {
    ...
    cout << "\033[0;36m /$$$$$$$$          /$$$$$$$$  /$$$$$$  /$$$$$$$$   \033[0m" << endl;
    cout << "\033[0;36m | $$_____/         | $$_____/ /$$__  $$|__  $$__/  \033[0m" << endl; 
    cout << "\033[0;36m | $$               | $$      | $$  \\__/   | $$    \033[0m" << endl; 
    cout << "\033[0;36m | $$$$$    /$$$$$$ | $$$$$   |  $$$$$$    | $$     \033[0m" << endl; 
    cout << "\033[0;36m | $$__/   |______/ | $$__/    \\____  $$   | $$    \033[0m" << endl; 
    cout << "\033[0;36m | $$               | $$       /$$  \\ $$   | $$    \033[0m" << endl; 
    cout << "\033[0;36m | $$               | $$$$$$$$|  $$$$$$/   | $$     \033[0m" << endl;  
    cout << "\033[0;36m |__/               |________/ \\______/    |__/    \033[0m" << endl;  
    cout << endl;
  ...
  //MPI_Barrier(fest_comm); //not friendly to concurrent programs
  //
  return;
}
